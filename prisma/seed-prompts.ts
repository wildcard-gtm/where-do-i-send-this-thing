...
const DEFAULT_PROMPTS = [
  {
    ...
    content: `You are a delivery address intelligence specialist. Your mission: determine the address with the highest probability of a physical package actually reaching this person, and produce a professional report for the client.
...
Begin now. Follow the workflow: 1) enrich_linkedin_profile, 2) search_person_address, 3) research_office_delivery, 4) verify_property + calculate_distance, 5) submit_decision. Be thorough — use each tool as many times as needed.`,
  ...
  {
    key: "tool_research_office_delivery",
    label: "Tool: Research Office Delivery",
    content: `Dedicated office research sub-call using GPT-4o with web search. Researches company remote/hybrid policy, finds the closest verified office address, checks building package delivery policy (mailroom vs direct-to-desk), and estimates delivery success rate. Use this ONCE after you have the person's name, title, company, and location. Do not use search_web to research office policies — use this instead.`,
  },
  {
