      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12 bg-slate-800/50 p-8 rounded-xl border border-slate-700">
          ...
          <p className="text-slate-300 leading-relaxed">
            ...
            <span className="block mt-2 text-lg font-mono bg-slate-900/50 p-4 rounded-lg">
              LinkedIn URLs → Enrichment → Address Discovery → Verification → Export
            </span>
          </p>
        </section>
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400">
                    ...
                    Dashboard → Upload → View Progress → Results
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">LinkedIn Upload → Enrichment UI</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="text-slate-400 space-y-2 list-disc list-inside">
                    ...
                    <li>Tool calls being made (Whitepages, PropMix, etc.)</li>
        ...
        <section className="mb-12">
          ...
          <p className="text-slate-400 mb-6">
            These are the APIs from the existing SlurpBot ops-portal that power address verification.
            <span className="block mt-2 text-yellow-400 font-semibold">
              ⚠️ Ask Shane for the API keys - don&apos;t commit them to the repo!
            </span>
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-800/50 p-6 rounded-xl border border-green-900/50">
              <h3 className="text-lg font-semibold text-green-400 mb-2">Whitepages API</h3>
              <p className="text-slate-400 text-sm mb-3">
                People search by name, phone, or address. Returns current addresses, owned properties, phones, emails.
              </p>
              <div className="bg-slate-900/50 p-3 rounded text-sm font-mono">
                <div className="text-slate-500">Endpoint:</div>
                <div className="text-slate-300">https://api.whitepages.com/v1/person</div>
                <div className="text-slate-500 mt-2">Env var:</div>
                <div className="text-green-400">WHITEPAGES_API_KEY</div>
              </div>
            </div>

            {/* PropMix */}
            <div className="bg-slate-800/50 p-6 rounded-xl border border-green-900/50">
              <h3 className="text-lg font-semibold text-green-400 mb-2">PropMix API</h3>
              <p className="text-slate-400 text-sm mb-3">
                Property data lookup - owner occupied status, owner names, sale history. Helps verify if address is current.
              </p>
              <div className="bg-slate-900/50 p-3 rounded text-sm font-mono">
                <div className="text-slate-500">Endpoint:</div>
                <div className="text-slate-300">https://api.propmix.io/pubrec/assessor/v1/GetPropertyDetails</div>
                <div className="text-slate-500 mt-2">Env var:</div>
            ...
            <div className="bg-slate-800/50 p-6 rounded-xl border border-green-900/50">
              <h3 className="text-lg font-semibold text-green-400 mb-2">Google Distance Matrix API</h3>
              <p className="text-slate-400 text-sm mb-3">
                Calculate driving distance between addresses. Helps determine if person commutes to office or is remote.
              </p>
              <div className="bg-slate-900/50 p-3 rounded text-sm font-mono">
                <div className="text-slate-500">Endpoint:</div>
                <div className="text-slate-300">https://maps.googleapis.com/maps/api/distancematrix/json</div>
                <div className="text-slate-500 mt-2">Env var:</div>
            ...
            {/* Exa AI */}
            <div className="bg-slate-800/50 p-6 rounded-xl border border-green-900/50">
              <h3 className="text-lg font-semibold text-green-400 mb-2">Exa AI Search</h3>
              <p className="text-slate-400 text-sm mb-3">
                Neural web search for finding current info about people and companies. Better semantic matching than traditional search.
              </p>
              <div className="bg-slate-900/50 p-3 rounded text-sm font-mono">
                <div className="text-slate-500">Endpoint:</div>
                <div className="text-slate-300">https://api.exa.ai/search</div>
                <div className="text-slate-500 mt-2">Env var:</div>
            ...
            {/* OpenAI */}
            <div className="bg-slate-800/50 p-6 rounded-xl border border-green-900/50">
              <h3 className="text-lg font-semibold text-green-400 mb-2">OpenAI API</h3>
              <p className="text-slate-400 text-sm mb-3">
                Powers the office address research tool (GPT-5.2 with web search). Also used for embeddings.
              </p>
              <div className="bg-slate-900/50 p-3 rounded text-sm font-mono">
                <div className="text-slate-500">Env var:</div>
                <div className="text-green-400">OPENAI_API_KEY</div>
              </div>
            </div>

            {/* LinkedIn Scraping */}
            <div className="bg-slate-800/50 p-6 rounded-xl border border-green-900/50">
              <h3 className="text-lg font-semibold text-green-400 mb-2">LinkedIn Data API</h3>
              <p className="text-slate-400 text-sm mb-3">
                For scraping/enriching LinkedIn profiles (likely Proxycurl or similar).
              </p>
              <div className="bg-slate-900/50 p-3 rounded text-sm font-mono">
                <div className="text-slate-500">Env var:</div>
                <div className="text-green-400">LI_API_KEY</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-slate-800/50 p-6 rounded-xl border border-purple-900/50">
            ...
            <ul className="text-slate-400 space-y-3">
              ...
              <li className="flex items-start gap-2">
                <span className="text-purple-400">•</span>
                <span><strong>Contact Point Matching:</strong> If verified contact points match Whitepages data, high confidence we have the right person.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-400">•</span>
                <span><strong>Common Name Problem:</strong> If &gt;5 Whitepages results, probably a common name. Get both home and office to be safe.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-400">•</span>
        ...
        <section className="mb-12">
          ...
          <div className="bg-slate-800/50 p-6 rounded-xl border border-orange-900/50 font-mono text-sm space-y-2">
            ...
            <div className="text-slate-300">apps/ops-portal/mastra/tools/whitepages-tool.ts</div>
            ...
            <div className="text-slate-300">apps/ops-portal/lib/services/whitepages-service.ts</div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-red-900/20 p-6 rounded-xl border border-red-900/50">
            <ol className="text-slate-300 space-y-4 list-decimal list-inside">
              <li><strong>Ask Shane for API keys</strong> for: Whitepages, PropMix, Google Maps, Exa AI, OpenAI, LinkedIn</li>
